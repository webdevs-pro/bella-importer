...
class WXR_Bella_Parser_Regex {
	...
	function parse( $file ) {
		...
		if ( ! $wxr_version )
			return new WP_Error( 'WXR_Bella_Bella_parse_error', __( 'This does not appear to be a WXR file, missing/invalid WXR version number', 'wordpress-importer' ) );
